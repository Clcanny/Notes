...
docker exec container1.2 bash -c "ping 172.0.1.3 -c 4"
docker exec container1.2 bash -c "ping 172.0.2.2 -c 4"
docker exec container1.2 bash -c "ping 172.0.2.3 -c 4"

docker exec container1.3 bash -c "ping 172.0.1.2 -c 4"
docker exec container1.3 bash -c "ping 172.0.2.2 -c 4"
docker exec container1.3 bash -c "ping 172.0.2.3 -c 4"

docker exec container2.2 bash -c "ping 172.0.1.2 -c 4"
docker exec container2.2 bash -c "ping 172.0.1.3 -c 4"
docker exec container2.2 bash -c "ping 172.0.2.3 -c 4"

docker exec container2.3 bash -c "ping 172.0.1.2 -c 4"
docker exec container2.3 bash -c "ping 172.0.1.3 -c 4"
docker exec container2.3 bash -c "ping 172.0.2.2 -c 4"
