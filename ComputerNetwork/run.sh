...
# 添加三条路由规则
docker exec router1 bash -c "ip route add default via 210.28.120.2 dev eth3"
...
# 添加三条路由规则
docker exec router1 bash -c "ip route add default via 210.28.120.1 dev eth1"
docker exec router1 bash -c "ip route add 210.28.130.0/24 via 210.28.130.1 dev eth2"
# 显示新的路由规则
docker exec router1 bash -c "ip route"
...
# docker exec container1 bash -c "ping 192.168.2.3 -c 4"
# docker exec container1 bash -c "ping 192.168.2.130 -c 4"
docker exec container1 bash -c "ping 210.28.130.2 -c 1"

# docker exec container2 bash -c "ping 192.168.2.2 -c 4"
# docker exec container2 bash -c "ping 192.168.2.130 -c 4"
# docker exec container2 bash -c "ping 210.28.130.3 -c 4"

# docker exec container4 bash -c "ping 192.168.2.2 -c 4"
# docker exec container4 bash -c "ping 192.168.2.3 -c 4"
# docker exec container4 bash -c "ping 192.168.2.130 -c 4"

# docker exec container3 bash -c "ping 192.168.2.2 -c 4"
# docker exec container3 bash -c "ping 192.168.2.3 -c 4"
# docker exec container3 bash -c "ping 210.28.130.3 -c 4"
